        ...
        while still_playing:
            ...
            if decision_after_roll_input.lower().strip() == "s":
                ...
                print(
                    ...
                    + str(self.score_collected_this_round)
                    + " in this round. \tIn total you have " +
    ...
    def computer_turn(self):
        ...
        while still_playing:
            ...
            should_stand = self.current_intelligence.make_choice(
                self.score_collected_this_round, self.current_player.get_score())

            if should_stand:
                self.current_intelligence.add_score(self.score_collected_this_round)
                print(
                    "Opponent collected " + str(self.score_collected_this_round)
                    + "\t ..and has a total score of "
                    + str(self.current_intelligence.get_score()) + "\n"
                )
